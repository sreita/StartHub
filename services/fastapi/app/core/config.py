...
# Ruta al directorio services/fastapi (donde está el .env)
# __file__ = .../services/fastapi/app/core/config.py
# parents[0] = .../services/fastapi/app/core
# parents[1] = .../services/fastapi/app
# parents[2] = .../services/fastapi
